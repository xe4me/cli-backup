...
import {PartnershipManagerBlockComponent} from '../../../../app/blocks/bolr/partnership-manager/partnership-manager.component';
...
@View({
  templateUrl: 'src/styleguide/blocks/bolr/partnership-manager/basic_usage.html',
