...
import { AmpQasAddressComponent } from '../../../../src/app/components/amp-qas-address/amp-qas-address.component';
...
describe( 'amp-qas-address component' , () => {
    ...
    it( 'should have create 2 controls and add them to the control group' , () => {
        ...
        expect( Component.controlGroup.controls.length ).toEqual( 2 );
    } );
} );
@Component( {
    template : `
