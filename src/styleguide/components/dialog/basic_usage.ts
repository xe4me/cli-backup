...
@View( {
    templateUrl : 'src/styleguide/components/dialog/basic_usage.html' ,
    styleUrls   : [ 'src/styleguide/components/dialog/basic_usage.css' ] ,
...
export default class DialogBasicUsage {
    ...
    showAlert ( ev ) {
        let config = new MdDialogConfig()
            ...
            .ok( 'Got it!' )
            .targetEvent( ev );
        this.dialog.open( <Type>MdDialogBasic , this.element , config );
    };
