...
@Component({
    ...
    inputs: ['id', 'label', 'parentControl', 'placeholder', 'visibility', 'valMaxLength', 'valPattern', 'isRequired', 'isInSummaryState'],
...
export class AMPGoogleAddressComponent implements AfterViewInit {
    ...
    static getAddressComponent(types: Array<string>, getShortName: boolean, addressComponent: Array<any>): string {
        let addr_comp = null;
