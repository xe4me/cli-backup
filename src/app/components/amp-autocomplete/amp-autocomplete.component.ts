...
import { MdInputComponent } from '../my-md-input/my-md-input.component.ts';
...
@Component( {
    ...
    template   : `
    <div [clicked-outside]="closeSearchResult" class="amp-autocomplete">
        <div class='control'> 
            <my-md-input
        ...
        <div class='options' [class.options--hidden]='hideOptions'>
            <div *ngFor='let option of options | myfilter:queryControl.value' 
                class='option' 
                [class.option--active]='option.id == selectedOption.id'
...
export class AmpAutocompleteComponent implements OnInit {
    ...
    private options        = [
        ...
        {
            "id": 157,
            "title": "Builder's supply merchant",
            "IPClass": "C",
            "TPDClass": "C"
        },
        {
    ...
    private get hideOptions () {
        return !this.queryControl.value || this.queryControl.value.length < 2;
    }
