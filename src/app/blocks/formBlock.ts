...
export abstract class FormBlock {
    ...
    constructor ( protected progressObserver? : ProgressObserverService ) {

        // // What about Application FormBlocks?
        // // TODO: Move this into the relevant blocks
        // //const quoteControl : FormControl = this.controlService.getControl( FullyDistinguishedNames.QuoteDetails ,
        // const quoteControl : FormControl = new FormControl();
        // // 'identifier' );
